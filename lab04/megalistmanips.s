...
mapLoop:
    lw t1, 0(s0)        # load the address of the array of current node into t1 # mistake 3
    lw t2, 4(s0)        # load the size of the node's array into t2

	li t3, 4
	mul t3, t3, t0
    add t1, t1, t3      # offset the array address by the count # mistake 5
    lw a0, 0(t1)        # load the value at that address into a0

	addi sp, sp, -12    # mistake 1
    sw t0, 0(sp)
    sw t1, 4(sp)
    sw t2, 8(sp)
